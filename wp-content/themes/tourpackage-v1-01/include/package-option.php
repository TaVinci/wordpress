<?php
	...
	*/
	...
	function create_package_post() {
		$package_translation = get_option(THEME_SHORT_NAME.'_package_slug','oferte');
		...
		register_taxonomy_for_object_type('package-category', 'package');
			...
			/*
		register_taxonomy(
			"package-sejur", array("package"), array(
				"hierarchical" => true,
				"label" => "Package  Sejur", 
				"singular_label" => "Package Sejur", 
				"rewrite" => true));
		register_taxonomy_for_object_type('package-sejur', 'package');
		
		register_taxonomy(
			"package-charter", array("package"), array(
				"hierarchical" => true,
				"label" => "Package Charter", 
				"singular_label" => "Package Charter", 
				"rewrite" => true));
		register_taxonomy_for_object_type('package-charter', 'package');
		
		register_taxonomy(
			"package-circuit", array("package"), array(
				"hierarchical" => true,
				"label" => "Package Circuit", 
				"singular_label" => "Package Circuit", 
				"rewrite" => true));
		register_taxonomy_for_object_type('package-circuit', 'package');
		
		register_taxonomy(
			"package-croaziera", array("package"), array(
				"hierarchical" => true,
				"label" => "Package Croaziera", 
				"singular_label" => "Package Croaziera", 
				"rewrite" => true));
		register_taxonomy_for_object_type('package-croaziera', 'package');
	...
	$package_meta_boxes = array(	
		...
		"Inside Thumbnail2" => array(
			'title'=> __('INSIDE PACKAGE THUMBNAIL', 'gdl_back_office'),
			'name'=>'post-option-inside-thumbnail2',
			'type'=>'upload'
		),	
					
		"Inside Thumbnail3" => array(
			'title'=> __('INSIDE PACKAGE THUMBNAIL', 'gdl_back_office'),
			'name'=>'post-option-inside-thumbnail3',
			'type'=>'upload'
		),
					
		"Inside Thumbnail4" => array(
			'title'=> __('INSIDE PACKAGE THUMBNAIL', 'gdl_back_office'),
			'name'=>'post-option-inside-thumbnail4',
			'type'=>'upload'
		),
					
		"Inside Thumbnail5" => array(
			'title'=> __('INSIDE PACKAGE THUMBNAIL', 'gdl_back_office'),
			'name'=>'post-option-inside-thumbnail5',
			'type'=>'upload'
		),	
			
			
			"Inside Thumbnail6" => array(
			'title'=> __('INSIDE PACKAGE THUMBNAIL', 'gdl_back_office'),
			'name'=>'post-option-inside-thumbnail6',
			'type'=>'upload'
		),	
		
		"Inside Thumbnail7" => array(
			'title'=> __('INSIDE PACKAGE THUMBNAIL', 'gdl_back_office'),
			'name'=>'post-option-inside-thumbnail7',
			'type'=>'upload'
		),	
		
		
		"Inside Thumbnail8" => array(
			'title'=> __('INSIDE PACKAGE THUMBNAIL', 'gdl_back_office'),
			'name'=>'post-option-inside-thumbnail8',
			'type'=>'upload'
		),	
		
		
		"Inside Thumbnail9" => array(
			'title'=> __('INSIDE PACKAGE THUMBNAIL', 'gdl_back_office'),
			'name'=>'post-option-inside-thumbnail9',
			'type'=>'upload'
		),	
		
		
		"Inside Thumbnail10" => array(
			'title'=> __('INSIDE PACKAGE THUMBNAIL', 'gdl_back_office'),
			'name'=>'post-option-inside-thumbnail10',
			'type'=>'upload'
		),	
