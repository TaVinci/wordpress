			...
			if ( have_posts() ){
				while (have_posts()){
					...
					print_single_package_thumbnail( get_the_ID(), $item_size, $package_ribbon, $package_type_text );
						// blog thumbnail	
					print_single_package_thumbnail2( get_the_ID(), $item_size, $package_ribbon, $package_type_text );
					print_single_package_thumbnail3( get_the_ID(), $item_size, $package_ribbon, $package_type_text );
					print_single_package_thumbnail4( get_the_ID(), $item_size, $package_ribbon, $package_type_text );
					print_single_package_thumbnail5( get_the_ID(), $item_size, $package_ribbon, $package_type_text );
					print_single_package_thumbnail6( get_the_ID(), $item_size, $package_ribbon, $package_type_text );
					print_single_package_thumbnail7( get_the_ID(), $item_size, $package_ribbon, $package_type_text );
					print_single_package_thumbnail8( get_the_ID(), $item_size, $package_ribbon, $package_type_text );
					print_single_package_thumbnail9( get_the_ID(), $item_size, $package_ribbon, $package_type_text );
					print_single_package_thumbnail10( get_the_ID(), $item_size, $package_ribbon, $package_type_text );
